...
//! finney Service and ServiceFactory implementation. Specialized wrapper over substrate service.
...
pub use finney_runtime::RuntimeApi;
...
/// finney runtime native executor.
pub struct Executor;
...
impl sc_executor::NativeExecutionDispatch for Executor {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        finney_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        finney_runtime::native_version()
    }
}
