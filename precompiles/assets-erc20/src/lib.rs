...
// AssetsERC20 package used in Uomi Network in terms of GPLv3.
//
...
/// 1024-2047 Precompiles that are not in Ethereum Mainnet but are neither Uomi specific
/// 2048-4095 Uomi specific precompiles
