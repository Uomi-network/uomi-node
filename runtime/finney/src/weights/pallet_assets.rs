...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("uomi-dev"), DB CACHE: 1024
...
impl<T: frame_system::Config> pallet_assets::WeightInfo for SubstrateWeight<T> {
	...
	/// Added to satisfy newer trait version. Approximate weight; benchmark to refine.
